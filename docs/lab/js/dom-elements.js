...
export const DOM_ELEMENTS = {
  ...
  options: {
    ...
    meanTripDistance: document.getElementById("option-mean-trip-distance"),
  ...
  whatIf: {
    ...
    totalBlocksInput: document.getElementById("what-if-total-blocks"),
    ...
    meanTripDistance: document.getElementById("what-if-mean-trip-distance"),
