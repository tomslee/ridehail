...
p +
  ...
  scale_x_continuous("Number of vehicles") +
  scale_y_continuous("Wait time (minutes)", limits=c(0, 10)) +
  ggtitle("Vehicles needed to provide a given wait time (135 trips/min)")
```
